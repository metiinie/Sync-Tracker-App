    ...
    return (
        <SafeAreaView className="flex-1 bg-white" edges={['top']}>
            ...
            <View className="flex-1">
                {activeTab === 'Overview' && <OverviewTab task={task} user={user} updateSyncState={updateSyncState} handleToggleMilestone={handleToggleMilestone} newTimeLog={newTimeLog} setNewTimeLog={setNewTimeLog} handleLogTime={handleLogTime} />}
                {activeTab === 'Tree' && <TreeViewTab task={task} />}
...
const OverviewTab = ({ task, user, updateSyncState, handleToggleMilestone, newTimeLog, setNewTimeLog, handleLogTime }: any) => {
    return (
